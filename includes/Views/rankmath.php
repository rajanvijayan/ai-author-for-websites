...
$rankmath             = $integrations_manager->get( 'rankmath' );
$settings             = $rankmath->get_settings();
$is_rankmath_active   = $rankmath->is_rankmath_active();

// Handle form submission.
// phpcs:disable WordPress.Security.ValidatedSanitizedInput.MissingUnslash -- All inputs are sanitized appropriately.
if ( isset( $_POST['aiauthor_rankmath_save'] ) && check_admin_referer( 'aiauthor_rankmath_nonce' ) ) {
	$aiauthor_new_settings = array(
		'enabled'                     => ! empty( $_POST['enabled'] ),
		'auto_generate_meta'          => ! empty( $_POST['auto_generate_meta'] ),
		'generate_focus_keyword'      => ! empty( $_POST['generate_focus_keyword'] ),
		...
		'generate_secondary_keywords' => ! empty( $_POST['generate_secondary_keywords'] ),
		'generate_og_meta'            => ! empty( $_POST['generate_og_meta'] ),
	);

	$rankmath->update_settings( $aiauthor_new_settings );
...
$logs = $rankmath->get_logs( 15 );
?>
<div class="wrap aiauthor-admin aiauthor-rankmath">
	<h1>
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ai-author-integrations' ) ); ?>" class="aiauthor-back-link">
			<span class="dashicons dashicons-arrow-left-alt"></span>
		</a>
		<span class="dashicons dashicons-chart-line" style="font-size: 30px; margin-right: 8px; color: #e94998;"></span>
		<?php esc_html_e( 'Rank Math SEO Integration', 'ai-author-for-websites' ); ?>
	</h1>
	...
	<?php if ( ! $is_rankmath_active ) : ?>
		<div class="notice notice-warning">
			<p>
				<strong><?php esc_html_e( 'Rank Math Not Detected', 'ai-author-for-websites' ); ?></strong> - 
				<?php esc_html_e( 'This integration requires Rank Math SEO plugin to be installed and activated.', 'ai-author-for-websites' ); ?>
			</p>
		</div>
	<?php endif; ?>

	<div class="aiauthor-info-card" style="border-color: #e94998; background: #fef5f9;">
		<h3>
			<span class="dashicons dashicons-info"></span>
			<?php esc_html_e( 'About This Integration', 'ai-author-for-websites' ); ?>
		</h3>
		<p>
			<?php esc_html_e( 'This integration automatically generates SEO metadata for your AI-generated posts using Rank Math SEO. It creates focus keywords, meta descriptions, SEO titles, and optional secondary keywords.', 'ai-author-for-websites' ); ?>
		</p>
		<ul style="margin: 10px 0 0 20px;">
			<li><?php esc_html_e( 'Focus Keyword: The primary keyword your content targets', 'ai-author-for-websites' ); ?></li>
			<li><?php esc_html_e( 'Secondary Keywords: Additional keywords to optimize for (Rank Math Pro feature)', 'ai-author-for-websites' ); ?></li>
			<li><?php esc_html_e( 'Meta Description: Compelling snippet for search results (up to 155 characters)', 'ai-author-for-websites' ); ?></li>
			<li><?php esc_html_e( 'SEO Title: Optimized title tag (up to 60 characters)', 'ai-author-for-websites' ); ?></li>
		</ul>
	</div>

	<form method="post" action="">
		<?php wp_nonce_field( 'aiauthor_rankmath_nonce' ); ?>
		...
		<div class="aiauthor-settings-grid">
			<div class="aiauthor-settings-main">
				...
				<div class="aiauthor-card">
					...
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="enabled"><?php esc_html_e( 'Enable Rank Math Integration', 'ai-author-for-websites' ); ?></label>
							</th>
							<td>
								<label class="aiauthor-switch aiauthor-switch-large">
									<input type="checkbox" 
											...
											<?php disabled( ! $is_rankmath_active ); ?>>
									<span class="slider"></span>
								</label>
								<p class="description">
									<?php esc_html_e( 'Enable automatic SEO optimization for AI-generated posts using Rank Math.', 'ai-author-for-websites' ); ?>
								</p>
							</td>
						</tr>
					</table>
				...
				<div class="aiauthor-card">
					...
					<table class="form-table">
						...
						<tr>
							<th scope="row">
								<label for="generate_focus_keyword"><?php esc_html_e( 'Generate Focus Keyword', 'ai-author-for-websites' ); ?></label>
							</th>
							<td>
								<label class="aiauthor-switch">
									<input type="checkbox" 
											id="generate_focus_keyword" 
											name="generate_focus_keyword" 
											value="1" 
											<?php checked( ! empty( $settings['generate_focus_keyword'] ) ); ?>>
									<span class="slider"></span>
								</label>
								<p class="description">
									<?php esc_html_e( 'Generate an AI-optimized focus keyword for SEO analysis.', 'ai-author-for-websites' ); ?>
								</p>
							</td>
						</tr>
						<tr>
							<th scope="row">
								<label for="generate_secondary_keywords"><?php esc_html_e( 'Generate Secondary Keywords', 'ai-author-for-websites' ); ?></label>
							</th>
							<td>
								<label class="aiauthor-switch">
									<input type="checkbox" 
											id="generate_secondary_keywords" 
											name="generate_secondary_keywords" 
											value="1" 
											<?php checked( ! empty( $settings['generate_secondary_keywords'] ) ); ?>>
									<span class="slider"></span>
								</label>
								<p class="description">
									<?php esc_html_e( 'Generate 3-5 additional secondary keywords. Best used with Rank Math Pro.', 'ai-author-for-websites' ); ?>
								</p>
							</td>
						</tr>
						<tr>
				...
				<div class="aiauthor-card">
					...
					<table class="form-table">
						<tr>
							<th scope="row">
								<label for="generate_og_meta"><?php esc_html_e( 'Generate Social Meta', 'ai-author-for-websites' ); ?></label>
							</th>
							<td>
								<label class="aiauthor-switch">
									<input type="checkbox" 
											id="generate_og_meta" 
											name="generate_og_meta" 
											value="1" 
											<?php checked( ! empty( $settings['generate_og_meta'] ) ); ?>>
									<span class="slider"></span>
								</label>
								<p class="description">
									<?php esc_html_e( 'Generate Open Graph / Twitter Card meta for social media sharing.', 'ai-author-for-websites' ); ?>
								</p>
							</td>
						</tr>
					</table>
			...
			<div class="aiauthor-settings-sidebar">
				...
				<div class="aiauthor-card">
					<h2>
						<span class="dashicons dashicons-star-filled" style="color: #e94998;"></span>
						<?php esc_html_e( 'Rank Math Features', 'ai-author-for-websites' ); ?>
					</h2>
					<ul class="aiauthor-tips-list">
						<li><?php esc_html_e( 'Focus keywords help track your SEO score.', 'ai-author-for-websites' ); ?></li>
						<li><?php esc_html_e( 'Secondary keywords are available in Rank Math Pro.', 'ai-author-for-websites' ); ?></li>
						<li><?php esc_html_e( 'Rank Math displays real-time SEO analysis in the editor.', 'ai-author-for-websites' ); ?></li>
						<li><?php esc_html_e( 'AI-generated meta helps improve click-through rates.', 'ai-author-for-websites' ); ?></li>
					</ul>
				</div>
				...
				<div class="aiauthor-card">
					...
					<p class="description"><?php esc_html_e( 'Recent Rank Math integration activity.', 'ai-author-for-websites' ); ?></p>
					<?php if ( empty( $logs ) ) : ?>
...
jQuery(document).ready(function($) {
	$('#test-generate-btn').on('click', function() {
		...
		$.ajax({
			url: '<?php echo esc_url( rest_url( 'ai-author/v1/rankmath/generate' ) ); ?>',
			type: 'POST',
			headers: {
			...
			success: function(response) {
				...
				if (response.success && response.data) {
					...
					html += '<div class="aiauthor-seo-item"><strong><?php echo esc_js( __( 'Focus Keyword:', 'ai-author-for-websites' ) ); ?></strong><br>' + (response.data.focus_keyword || '-') + '</div>';
					...
					if (response.data.secondary_keywords) {
						html += '<div class="aiauthor-seo-item"><strong><?php echo esc_js( __( 'Secondary Keywords:', 'ai-author-for-websites' ) ); ?></strong><br>' + response.data.secondary_keywords.join(', ') + '</div>';
					}
					html += '</div>';
